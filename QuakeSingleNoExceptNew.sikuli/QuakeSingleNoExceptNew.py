...
imgGameList = Pattern("imgGameList.png").similar(0.88).targetOffset(-58,-58)
imgGameListOffs = Pattern("imgGameList.png").similar(0.88).targetOffset(-11,-60)
