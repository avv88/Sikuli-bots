...
adm_ships = []
adm_ships.append(("1592656378162.png",3,2,1,0))
adm_ships.append(("1592656389530.png",5,3,2,0))
adm_ships.append(("1592656415551.png",4,1,1,0))
adm_ships.append(("1592656432386.png",6,4,4,0))
adm_ships.append(("1592656441777.png",2,2,2,0))
adm_ships.append(("1592656453619.png",4,3,3,0))
adm_ships.append(("1592656480482.png",32,52,14,12))
adm_ships.append(("1592656493864.png",35,57,16,18))
adm_ships.append(("1592656514722.png",37,62,18,18))
adm_ships.append(("1592656566232.png",20,55,15,12))
adm_ships.append(("1592656765856.png",35,51,19,12))
adm_ships.append(("1592656591209.png",52,17,21,12))
adm_ships.append(("1592656602976.png",25,52,28,12))
adm_ships.append(("1592656611353.png",20,54,24,12))
adm_ships.append(("1592656621674.png",24,54,20,12))
adm_ships.append(("1592656629705.png",20,50,20,12))
...
adm_ships.append(("1593147711207.png",20,15,55,12))
...
scrollImg = Pattern("scrollImg.png").similar(0.93).targetOffset(0,-7)
...
HoverOn = Pattern("HoverOn.png").similar(0.90)
...
whitelist.append((Pattern("1591514859193.png").targetOffset(333,29),8,"engineering"))
whitelist.append((Pattern("1591678146412.png").targetOffset(362,26),8,"engineering"))
whitelist.append((Pattern("1591971465687.png").targetOffset(384,29),8,"engineering"))
whitelist.append((Pattern("1591291710128.png").targetOffset(348,29),8, "engineering"))
whitelist.append((Pattern("1591291722054.png").targetOffset(371,29),8, "engineering"))
whitelist.append((Pattern("1591514907063.png").targetOffset(351,29),8,"engineering"))
whitelist.append((Pattern("1591291741043.png").targetOffset(343,32),8, "engineering"))
whitelist.append((Pattern("1592129921844.png").similar(0.78).targetOffset(345,40),8,"engineering"))
whitelist.append((Pattern("1591514952297.png").targetOffset(344,34),8,"engineering"))
whitelist.append((Pattern("1591609931924.png").targetOffset(385,35),8,"engineering"))
whitelist.append((Pattern("1591291751258.png").targetOffset(345,28),8, "engineering"))
whitelist.append((Pattern("1591291761412.png").targetOffset(357,32),8, "engineering"))
whitelist.append((Pattern("1591291782442.png").targetOffset(367,29),8, "engineering"))
whitelist.append((Pattern("1591291795865.png").targetOffset(363,28),8, "engineering"))
whitelist.append((Pattern("1591459797193.png").targetOffset(341,33),8,"engineering"))
whitelist.append((Pattern("1591325023323.png").targetOffset(305,29),8,"engineering"))
...
whitelist.append((Pattern("1595137576406.png").targetOffset(419,31),1,"personal"))
...
def PatchGame():
    ...
    SafeClick(exitOk)
    wait(10)
    switchApp("C:\\Program Files (x86)\\Arc\\Arc.exe")
    wait(10)
    SafeClick(playImgArc)
    wait(120)
...
def AdmGetAvailableShips(tod = False):
    ...
    while exists(scrollImg):
     for i in range(len(ships)):
         if i in ids:
             continue
         if ships[i][4] == 100 and adm_started % 10 != 0:
             continue
         if exists(ships[i][0]):
             ids.append(i)
     if exists(scrollImg):
        ...
        if exists(item):
            ...
            if not has_shuttle: 
                if allTOD:
                    return 0
                SafeClick(adm_select1)
                for ship in adm_ships:
                    if ship[4] == 0 and exists(ship[0]):
                        click(ship[0])
                        has_shuttle = True
                        wait(1)
                        SafeClick(adm_assign)
                        SafeClick(adm_begin)
                        wait(5)
                        return
                        break
...
def RunTOD(faction_index):
    ...
    if best_ids[0] != -1:
        ...
        found = False
        while exists(scrollImg) and not found:
...
while True:
    ...
    if (time.time() - lastDailyCheck) > 2400: #40*60 sec
        ...
        SafeClick(doffBtn)
    CheckCompleted()
    if exists(noSlotsImg) and USE_LOGOFF:
        CheckAdm()
        Logoff()
        wait(randrange(1800,3000))
        Login()
